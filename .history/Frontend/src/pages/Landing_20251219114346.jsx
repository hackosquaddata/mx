              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-400/30 rounded-lg p-3 mb-4">
                    <div className="text-emerald-300 font-semibold text-sm">✨ Special Offer <span className="text-emerald-200 font-bold ml-2">50% OFF for first 100 users, no code needed</span></div>
                    <div className="text-slate-300 text-xs mt-1">Get a <strong>FREE MJPT Exam Voucher</strong> when you enroll</div>
                    <div className="text-emerald-300 text-xs mt-1 font-semibold">50% OFF for first 100 users, no code needed</div>
                  </div>
                </div>
          ...
          <div className="relative max-w-md w-full rounded-2xl bg-gradient-to-br from-[#120F18] to-[#0a0f14] border border-emerald-400/30 p-8 shadow-2xl animate-bounce-in">
            ...
            <div className="text-center">
              ...
              <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-3 mb-6">
                <div className="text-red-200 text-xs font-semibold mb-1">⚡ LIMITED TIME OFFER <span className="text-emerald-200 font-bold ml-2">50% OFF for first 100 users, no code needed</span></div>
                <div className="text-emerald-300 text-lg font-extrabold">50% OFF <span className="text-emerald-200 font-bold ml-2">No code needed</span></div>
